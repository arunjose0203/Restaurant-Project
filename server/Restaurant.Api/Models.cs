...
public class Bill : BranchRecord { public string InvoiceNumber {get;set;}=""; public string QuoteJson {get;set;}=""; public Guid Id {get;set;}=Guid.NewGuid(); public Guid SessionId {get;set;} public int TableId {get;set;} public Guid CashierId {get;set;} public decimal Total {get;set;} public int PaymentMethodId {get;set;} public string Reference {get;set;}=""; public DateTime PaidAt {get;set;}=DateTime.UtcNow; }
